...
const safeJapanText: AppText = {
  ...
  board: {
    ...
    heroLabel: 'Mugimaru Board',
    heroTitle: 'コミュニティ',
    heroCaption: '投稿、質問、イベント情報を犬友とシェアできます。',
    searchPlaceholder: '投稿を検索',
    categories: ['雑談', 'お知らせ', '質問', 'イベント', 'レビュー'],
    latestThreads: '新着スレッド',
    itemsCount: '{count}件',
    ...
    seedPosts: [
      ...
      {
        id: '2',
        title: '週末に豊洲エリアでお散歩会をします',
        body: '日曜10:30開始。小型犬から中型犬まで歓迎です。',
        author: 'board_admin',
        category: 'イベント',
        replies: 4,
        updatedAt: '23分前',
  ...
  map: {
    title: 'マップ',
    caption: 'スポットと口コミを確認できます',
    note: 'Google Map描画にはDev Clientが必要です。データ表示は利用できます。',
    loading: '読み込み中...',
    envMissing: 'Supabase環境変数が未設定のため、ローカルデータで表示しています。',
    connected: 'Supabaseに接続しました。',
    failedLoadSpots: 'スポットの取得に失敗しました。',
    failedLoadReviews: '口コミの取得に失敗しました。',
    spotRequired: 'スポット名と有効な緯度・経度を入力してください。',
    addedLocalSpot: 'ローカルに追加しました。Supabase設定後に永続化できます。',
    savedSpot: 'スポットを保存しました。',
    failedSaveSpot: 'スポット保存に失敗しました。',
    selectSpotFirst: '先にスポットを選択してください。',
    reviewRequired: '投稿者名、評価、口コミ内容を入力してください。',
    addedLocalReview: '口コミをローカルに追加しました。',
    savedReview: '口コミを保存しました。',
    failedSaveReview: '口コミ保存に失敗しました。',
    addSpotTitle: 'スポットを追加',
    dogRun: 'ドッグラン',
    vetClinic: '動物病院',
